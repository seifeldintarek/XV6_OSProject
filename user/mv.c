...
main(int argc, char *argv[])
{
    ...
    if (argc == 2 && argv[1][0] == '?' && argv[1][1] == '\0') {
        ...
        printf("Move or rename a file from old_path to new_path.\n");
        printf("If new_path is a directory, the file is moved inside that directory.\n");
        printf("Example: mv file.txt dir/\n");
        exit(0);
    }
